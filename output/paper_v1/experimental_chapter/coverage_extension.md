...
- Continuous matched comparisons: 38/43 have equal independent/CPS objectives; 5 have a higher coupled objective.
- Discrete matched comparisons: 45/45 have equal objectives.
- 24 continuous-fidelity cases satisfy coupling at unchanged k where the saved independent output violates it. Such a violation is permitted for independent simplification.
