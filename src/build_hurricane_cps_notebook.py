...
code('''source_files=[ROOT/name for name in ['src/hurricane_cps.py','src/curve_algorithms.py','src/cps_paper_algorithms.py','src/cps_graph_sizes.py']]
...
nbf.write(nb,root/'notebooks/legacy/1.analyze_CPS.ipynb')
