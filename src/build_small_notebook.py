...
""")
source=(root/'src/curve_algorithms.py').read_text()
...
""")
source=(root/'src/small_pair_solvers.py').read_text()
...
""")
pipeline=(root/'src/small_pair_pipeline.py').read_text()
...
nbf.validate(nb);nbf.write(nb,root/'notebooks/legacy/1.analyze_independent.ipynb')
