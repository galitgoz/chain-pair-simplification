...
""")
alg=(root/'decimation_algorithms.py').read_text()
...
""")
pipeline=(root/'decimation_pipeline.py').read_text()
...
nbf.validate(nb);nbf.write(nb,root/'1.analyze_independent.ipynb');print(f'Built {len(cells)} cells')
