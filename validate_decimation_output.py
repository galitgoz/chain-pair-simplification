...
root=Path(__file__).resolve().parent;out=root/'output/decimation'
nb=nbformat.read(root/'1.analyze_independent.ipynb',as_version=4);nbformat.validate(nb)
...
nbformat.write(nb,root/'1.analyze_independent.ipynb')
