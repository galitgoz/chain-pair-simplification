...
code('''source_files = [ROOT/'cps_paper_algorithms.py', ROOT/'curve_algorithms.py',
 ROOT/'cps_notebook_data.py', ROOT/'cps_notebook_run.py', ROOT/'cps_quality.py',
 ROOT/'cps_quality_plots.py', ROOT/'cps_notebook_plots.py', ROOT/'cps_parameter_table.py',
...
nbf.write(nb,root/'0.analyze_CPS.ipynb')
